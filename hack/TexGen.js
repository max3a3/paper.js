 ...
 * https://github.com/max3a3/texgen.js/blob/improvements/src/TexGen.js
 */
var TG = {};
...
TG.Texture.prototype = {
    ...
    alpha: function (param) {
        ...
        for (var i = 0, il = array.length; i < il; i += 4) {
            ...
            /* program start (use hardcoded program for now)*/
            switch (param) {
                case 'r':
                    array[i + 3] = array [i]
                    break;
                ...
                case 'b':
                    ...
                    break
                default:
                    array[i + 3] = (array [i] + array[i + 1] + array [i + 2]) / 3
